...
void prisma(GLuint textura1)  //Funcion creacion prisma
{
	...
	glNormal3f(0.0f, 0.0f, -1.0f);
	glTexCoord2f(0.750f, 0.330f); glVertex3fv(vertice[6]);
	glTexCoord2f(1.0f, 0.330f); glVertex3fv(vertice[5]);
	glTexCoord2f(1.0f, 0.66f); glVertex3fv(vertice[3]);
	glTexCoord2f(0.75f, 0.660f); glVertex3fv(vertice[2]);
	glEnd();
