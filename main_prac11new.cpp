...
B ------ > Movimiento Rodilla Derecha
N ------ > Movimiento Rodilla Izquierda
V ------ > Movimiento Mano Derecha
M ------ > Movimiento Mano Izquierda
X ------ > Movimiento Cuello
C ------ > Movimiento Cintura
J ------ > Movimiento de Cuerpo Derecha
G ------ > Movimiento de Cuerpo Izquierda
Y ------ > Movimiento de Cuerpo de Frente
H ------ > Movimiento de Cuerpo hacia Atras
...
float posX =0, posY = 2.5, posZ =-3.5, rotRodIzq = 0,rotRodDer=0, rotManDer=0, rotManIzq = 0, rotCin = 0, rotCue = 0 ; //agregar variable para manipular monito+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
float giroMonito = 0;

#define MAX_FRAMES 30
int i_max_steps = 90; //hora de Frams entre menos sea el numero mas lento es la animacion
int i_curr_steps = 0;//donde comienza el indice

typedef struct _frame //variables necesarias para los frame
{
	float rotRodIzq;
	float rotRodDer;//variable para la estructura del key frame //++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	float rotManIzq;
	float rotManDer;
	float rotCin;
	float rotCue;
	...
	float rotRodDerInc;//varaible para el incremento de la rodilla derecha ++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	float rotManIzqInc;
	float rotManDerInc;
	float rotCinInc;
	float rotCueInc;
...
void saveFrame ( void )
{
	...
	KeyFrame[FrameIndex].rotRodDer = rotRodDer;//para la rotacion derecha++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	KeyFrame[FrameIndex].rotManIzq = rotManIzq;
	KeyFrame[FrameIndex].rotManDer = rotManDer;
	KeyFrame[FrameIndex].rotCin = rotCin;
	KeyFrame[FrameIndex].rotCue = rotCue;
	//++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	KeyFrame[FrameIndex].posX=posX; //Laposicion se guarde para la animacion 
...
void interpolation ( void )
{
	...
	// poscicion final- posocion inicial / numero de pasos
	...
	KeyFrame[playIndex].rotRodDerInc = (KeyFrame[playIndex + 1].rotRodDer - KeyFrame[playIndex].rotRodDer) / i_max_steps;//Se agrego esto ++++++++++++++++++++++++++++++++++++++++++++++++++++++++
	KeyFrame[playIndex].rotManIzqInc = (KeyFrame[playIndex + 1].rotManIzq - KeyFrame[playIndex].rotManIzq) / i_max_steps;
	KeyFrame[playIndex].rotManDerInc = (KeyFrame[playIndex + 1].rotManDer - KeyFrame[playIndex].rotManDer) / i_max_steps;
	KeyFrame[playIndex].rotCinInc = (KeyFrame[playIndex + 1].rotCin - KeyFrame[playIndex].rotCin) / i_max_steps;
	KeyFrame[playIndex].rotCueInc = (KeyFrame[playIndex + 1].rotCue - KeyFrame[playIndex].rotCue) / i_max_steps;
	...
	glPushMatrix();//Pecho
		...
		glPushMatrix();//Cintura
			...
			glPushMatrix(); //Pie Derecho -->
				...
				glPushMatrix();
					glTranslatef(0, -0.5, 0);
					glRotatef(15+rotRodDer, 1, 0, 0); //Se agrega la variable rot++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
...
void animacion()
{
	...
	{		
		...
		else
		{
			...
			rotRodDer += KeyFrame[playIndex].rotRodDerInc;// para la animacion+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			rotManIzq += KeyFrame[playIndex].rotManIzqInc;
			rotManDer += KeyFrame[playIndex].rotManDerInc;
			rotCin += KeyFrame[playIndex].rotCinInc;
			rotCue += KeyFrame[playIndex].rotCueInc;
...
void keyboard ( unsigned char key, int x, int y )  // Create Keyboard Function
{
	switch ( key ) {
		...
		case 'n'://Ultima modificacion (se agrega una nueva tecla)++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++
			rotRodDer++;
			printf("%f \n", rotRodDer);
			break;
